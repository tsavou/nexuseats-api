...
import { IsNotEmpty, IsString, Matches, IsISO31661Alpha2 } from 'class-validator';
...
export class AddressDto {
  ...
  @IsISO31661Alpha2({ message: 'Le format du pays doit être un code ISO-3166-1 alpha-2 (ex: FR)' })
  country: string;
}
