import { Controller, Post, Body, Get, UseGuards, Request, VERSION_NEUTRAL } from '@nestjs/common';
...
export class AuthController {
  ...
  @ApiResponse({ status: 201, description: 'Connexion réussie, retourne le JWT.' })
